...
const DICT = {
  ...
  'nav.layer.overview': { vi: 'Tầng Thông báo, Tổng quan công việc', en: 'Notifications & Overview' },
  'nav.layer.operations': { vi: 'Tầng Phòng ban điều hành', en: 'Operating Departments' },
  'nav.layer.centers': { vi: 'Tầng Hệ thống trung tâm', en: 'Center System' },
  'nav.layer.personal': { vi: 'Tầng Cá nhân', en: 'Personal' },
