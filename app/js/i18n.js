...
const DICT = {
  ...
  'lobby.entry.checkinTitle': { vi: 'Chấm công nhanh', en: 'Quick check-in' },
  'lobby.back': { vi: '← Quay lại', en: '← Back' },
  'lobby.branches.sub': { vi: 'Chọn 1 khu vực để bắt đầu', en: 'Choose an area to get started' },
  'lobby.branch.room.name': { vi: 'Cá nhân', en: 'Personal' },
  'lobby.branch.room.desc': { vi: 'Hồ sơ, lịch, đơn từ của bạn', en: 'Your profile, calendar, requests' },
  'lobby.branch.erp.name': { vi: 'Hành chính', en: 'Administration' },
  'lobby.branch.erp.desc': { vi: 'Ban điều hành, các phòng ban', en: 'Executive board, departments' },
  'lobby.branch.crm.name': { vi: 'Trung tâm', en: 'Centers' },
  'lobby.branch.crm.desc': { vi: 'Vận hành các trung tâm', en: 'Center operations' },
  'lobby.branch.banzone.name': { vi: 'Dữ liệu', en: 'Data' },
  'lobby.branch.banzone.desc': { vi: 'Dữ liệu gốc toàn hệ thống', en: 'System-wide master data' },
  ...
  'lobby.banzone.catAcc': { vi: 'Kế toán', en: 'Accounting' },
  'lobby.banzone.catCenter': { vi: 'Trung tâm & Học vụ', en: 'Centers & Academic' },
  'lobby.banzone.catWarehouse': { vi: 'Kho vận', en: 'Warehouse' },
  'lobby.banzone.catOrgSystem': { vi: 'Tổ chức hệ thống', en: 'System organization' },
