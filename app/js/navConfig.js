...
export const NAV_CONFIG = [
  ...
  },
  {
    ...
    items: [
      ...
      { labelKey: 'nav.acc.discountPrograms', label: 'Hệ thống ưu đãi & Chiết khấu ví', href: '/acc/discount-programs.html', icon: '<svg class="icon" viewBox="0 0 24 24"><circle cx="7" cy="7" r="2.5"/><circle cx="17" cy="17" r="2.5"/><path d="M18 6L6 18"/></svg>', visible: (p) => inDept(p, 'ACC') },
