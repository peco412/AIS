...
export const NAV_CONFIG = [
  ...
  },
  {
    ...
    items: [
      ...
      { labelKey: 'nav.hr.attendanceAdjustments', label: 'Điều chỉnh chấm công', href: '/hr/attendance-adjustments.html', icon: '<svg class="icon" viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 3"/><path d="M9 21l3-3 3 3" stroke-dasharray="1 3"/></svg>', visible: (p) => (inDept(p, 'HR') && isDeptHeadOrAbove(p)) || inDept(p, 'ACC') || isExecOrTech(p) },
  ...
  },
  {
    ...
    items: [
      ...
      { labelKey: 'nav.mkt.parentAnnouncements', label: 'Thông báo cho Phụ huynh', href: '/mkt/parent-announcements.html', icon: '<svg class="icon" viewBox="0 0 24 24"><path d="M6 8a6 6 0 1 1 12 0c0 4 1.5 6 2 6.5H4c.5-.5 2-2.5 2-6.5z"/><path d="M9.5 18a2.5 2.5 0 0 0 5 0"/></svg>', visible: (p) => p.isCenterManager || inDept(p, 'MKT') || inDept(p, 'EDU') || isExecOrTech(p) },
      { labelKey: 'nav.mkt.extracurricular', label: 'Chương trình ngoại khoá', href: '/mkt/extracurricular-programs.html', icon: '<svg class="icon" viewBox="0 0 24 24"><path d="M12 2l3 6 7 1-5 5 1.5 7L12 18l-6.5 3L7 14 2 9l7-1z"/></svg>', visible: (p) => p.isCenterManager || inDept(p, 'MKT') || inDept(p, 'EDU') || isExecOrTech(p) },
  ...
  },
  {
    ...
    items: [
      ...
      { subgroup: 'tuition', labelKey: 'nav.acc.walletTopupRequests', label: 'Tổng hợp nạp ví', href: '/acc/wallet-topup-requests.html', icon: '<svg class="icon" viewBox="0 0 24 24"><path d="M4 6h16M4 12h16M4 18h10"/></svg>', visible: (p) => p.isCenterManager || inDept(p, 'ACC') || ['EXECUTIVE', 'TECH'].includes(p.roleCode) },
      ...
      { subgroup: 'role', labelKey: 'nav.edu.parentLinks', label: 'Liên kết Phụ huynh & Ví', href: '/edu/parent-links.html', icon: '<svg class="icon" viewBox="0 0 24 24"><path d="M9 15l6-6"/><path d="M11 6l1-1a4 4 0 0 1 6 6l-1 1"/><path d="M13 18l-1 1a4 4 0 0 1-6-6l1-1"/></svg>', visible: (p) => p.isCenterManager || inDept(p, 'ACC') || isExecOrTech(p) },
  ...
  },
  {
    ...
    items: [
      ...
      { labelKey: 'nav.md.suppliers', label: 'Nhà cung cấp', href: '/acc/suppliers.html', icon: '<svg class="icon" viewBox="0 0 24 24"><path d="M3 21V10l6 4v-4l6 4V8l6 4v9H3z"/><path d="M3 21h18"/></svg>', visible: (p) => ['TECH', 'EXECUTIVE', 'CENTER_MANAGER'].includes(p.roleCode) || inDept(p, 'ACC') },
      ...
      { labelKey: 'nav.md.programPlanDiscounts', label: 'Ưu đãi & Hình thức theo chương trình', href: '/master-data/program-plan-discounts.html', icon: '<svg class="icon" viewBox="0 0 24 24"><path d="M3 7l6 6 4-4 8 8"/><path d="M15 17h6v-6"/></svg>', visible: (p) => ['TECH', 'EXECUTIVE'].includes(p.roleCode) || inDept(p, 'ACC') },
