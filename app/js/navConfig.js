...
export const NAV_CONFIG = [
  ...
  },
  {
    ...
    items: [
      ...
      { subgroup: 'role', labelKey: 'nav.edu.parentAnnouncements', label: 'Thông báo cho Phụ huynh', href: '/edu/parent-announcements.html', icon: '<svg class="icon" viewBox="0 0 24 24"><path d="M6 8a6 6 0 1 1 12 0c0 4 1.5 6 2 6.5H4c.5-.5 2-2.5 2-6.5z"/><path d="M9.5 18a2.5 2.5 0 0 0 5 0"/></svg>', visible: (p) => p.isCenterManager || inDept(p, 'MKT') || inDept(p, 'EDU') || isExecOrTech(p) },
      { subgroup: 'role', labelKey: 'nav.edu.extracurricular', label: 'Chương trình ngoại khoá', href: '/edu/extracurricular-programs.html', icon: '<svg class="icon" viewBox="0 0 24 24"><path d="M12 2l3 6 7 1-5 5 1.5 7L12 18l-6.5 3L7 14 2 9l7-1z"/></svg>', visible: (p) => p.isCenterManager || inDept(p, 'MKT') || inDept(p, 'EDU') || isExecOrTech(p) },
