...
const STATUS_LABEL = {
  draft: 'Chờ truyền thông duyệt', submitted: 'Chờ truyền thông duyệt',
  approved_1: 'Chờ ban điều hành duyệt', approved_2: 'Đã lưu trữ', archived: 'Đã lưu trữ', rejected: 'Từ chối',
};
...
(async () => {
  try {
    ...
    IS_MKT_HEAD = profile.departmentCode === 'MKT' && ['DEPT_HEAD', 'DEPT_DEPUTY'].includes(profile.roleCode);
