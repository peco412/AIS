...
insert into document_templates (code, name, file_url) values
  ('01.Hopdonglaodong', 'Hợp đồng lao động', 'https://01.Hopdonglaodong.pdf'),
  ('02.Phieudenghithanhtoan', 'Phiếu đề nghị thanh toán', 'https://02.Phieudenghithanhtoan.pdf'),
  ('03.Phieudenghitamung', 'Phiếu đề nghị tạm ứng', 'https://03.Phieudenghitamung.pdf'),
  ('04.Phieutrinhsukien', 'Phiếu trình sự kiện', 'https://04.Phieutrinhsukien.pdf'),
  ('05.Phieudenghimuasam', 'Phiếu đề nghị mua sắm', 'https://05.Phieudenghimuasam.pdf');
